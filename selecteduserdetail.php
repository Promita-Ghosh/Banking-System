...
<body style="background-color : #46469e ;">
	...
	<div class="container">
        ...
        <div>
            <table class="table table-striped table-condensed table-bordered">
                ...
                <tr>
                    <th class="text-left">Account Balane(in Rs.)</th>
        ...
        <br>
            ...
            <div class="text-center" >
                <button class="btn mt-3" name="submit" type="submit" id="myBtn" >Transfer Money</button><br><br><br>
            </div>
        </form>
    </div>
    <footer class="footer-content">
    <p>developed by  <b>&copy;Promita Ghosh</b><br>The Sparks Foundation</p>
    </footer>
